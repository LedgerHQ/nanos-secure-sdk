...
// The DEPENDENCY tag may have several occurrences, one for each dependency (by name). Malformed (multiple dep to the same lib with different version is is not ORed but ANDed, and then considered bogus)

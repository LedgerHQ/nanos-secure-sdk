...
typedef struct io_seph_s {
  ...
  // current ux_menu context (could be pluralised if multiple nested levels of
  // menu are required within bolos_ux for example)
  ux_menu_state_t menu;
  ux_turner_state_t turner;
#ifdef BOLOS_RELEASE
#ifdef TARGET_NANOX

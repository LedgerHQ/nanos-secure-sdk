...
/**
 * Receive next HID transport packet, returns IO_USB_APDU_RECEIVED when a complete APDU has been
 * received in the G_io_apdu_buffer To be called typically upon USB OUT event
 */

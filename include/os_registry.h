 ...
 * need to play with the tlvoffset. Add +1 to skip to the next one when searching for multiple tag
 * occurrences.
 * @param tag The tag to be searched for
 * @param value_offset The offset within the value for this occurrence of the tag. The
 * OS_REGISTRY_GET_TAG_OFFSET_COMPARE_WITH_BUFFER or OS_REGISTRY_GET_TAG_OFFSET_GET_LENGTH can be
 * ORed to perform meta operation on the TLV occurrence.

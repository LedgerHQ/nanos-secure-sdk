 ...
 */
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) unsigned int os_registry_get_tag(unsigned int app_idx, unsigned int* tlvoffset, unsigned int tag, unsigned int value_offset, void* buffer PLENGTH(maxlength), unsigned int maxlength);
...
SYSCALL PERMISSION(APPLICATION_FLAG_BOLOS_UX) void           os_registry_get(unsigned int app_idx, application_t* out_application_entry PLENGTH(sizeof(application_t)));

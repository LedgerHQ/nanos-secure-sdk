...
SYSCALL       PERMISSION(APPLICATION_FLAG_BOLOS_UX) void os_perso_derive_and_xor_seed(void);
...
#define os_perso_derive_node_bip32_seed_key(                                     \
    mode, curve, path, pathLength, privateKey, chain, seed_key, seed_key_length) \

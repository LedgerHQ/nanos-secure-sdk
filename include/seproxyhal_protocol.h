...
#define SEPROXYHAL_TAG_BLE_SECURITY_DB_LOADED_EVENT 0x00 // the security db chunk has ben loaded into MCU's RAM, the SE can proceed with the next one
#define SEPROXYHAL_TAG_BLE_SECURITY_DB_DUMP_EVENT   0x01 // <off2BE> <data> content of the security db at given offset
...
#define SEPROXYHAL_TAG_BLE_SECURITY_DB_CMD_READ     0x01 // -noarg- request the content of the security db to be transmitted through SEPROXYHAL_TAG_BLE_SECURITY_DB_EVENT

 ...
 */
DEPRECATED static inline int cx_des_init_key(const unsigned char *rawkey,
 ...
 */
DEPRECATED static inline int cx_des_iv(const cx_des_key_t  *key,
                                       int                  mode,
                                       unsigned char       *iv,
                                       unsigned int         iv_len,
 ...
 * See #cx_des_no_throw
 */
DEPRECATED static inline int cx_des(const cx_des_key_t  *key,
                                    int                  mode,
                                    const unsigned char *in,
                                    unsigned int         in_len,
                                    unsigned char       *out,

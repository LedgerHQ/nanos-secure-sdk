 ...
 */
DEPRECATED static inline int cx_ecfp_add_point(cx_curve_t           curve,
                                               unsigned char       *R,
 ...
 */
DEPRECATED static inline int cx_ecfp_scalar_mult(cx_curve_t           curve,
                                                 unsigned char       *P,
                                                 unsigned int         P_len,
 ...
 */
DEPRECATED static inline int cx_ecfp_init_public_key(cx_curve_t            curve,
 ...
 */
DEPRECATED static inline int cx_ecfp_init_private_key(cx_curve_t             curve,
                                                      const unsigned char   *rawkey,
                                                      unsigned int           key_len,
                                                      cx_ecfp_private_key_t *pvkey)
{

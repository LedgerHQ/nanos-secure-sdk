...
static const cx_aead_base_t cx_aes_gcm_functions = {
  ...
  (cx_err_t(*) (void *ctx, const uint8_t *input, size_t len,
                ...
                uint8_t *output, uint8_t *tag, size_t tag_len))cx_aes_gcm_encrypt_and_tag,
  (cx_err_t(*) (void *ctx, const uint8_t *input, size_t len,
                const uint8_t *iv, size_t iv_len,
                const uint8_t *aad, size_t aad_len,
                uint8_t *output, const uint8_t *tag, size_t tag_len))cx_aes_gcm_decrypt_and_auth,
...
static cx_err_t cx_aes_gcm_process_and_tag(cx_aes_gcm_context_t *ctx, uint32_t mode, uint8_t *in, size_t len,
...
cx_err_t cx_aes_gcm_encrypt_and_tag(cx_aes_gcm_context_t *ctx, uint8_t *in, size_t len,
                                    const uint8_t *iv, size_t iv_len, const uint8_t *aad, size_t aad_len,
                                    uint8_t *out, uint8_t *tag, size_t tag_len) {
  return cx_aes_gcm_process_and_tag(ctx, CX_ENCRYPT, in, len, iv, iv_len, aad, aad_len,
                                    out, tag, tag_len);
}
...
cx_err_t cx_aes_gcm_decrypt_and_auth(cx_aes_gcm_context_t *ctx, uint8_t *in, size_t len,
  ...
  CX_CHECK(cx_aes_gcm_process_and_tag(ctx, CX_DECRYPT, in, len, iv, iv_len,

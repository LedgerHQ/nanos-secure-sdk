...
static void test_chacha_round(void **state) {
  ...
  uint32_t expected_array[16] = {0x837778ab, 0xe238d763, 0xa67ae21e, 0x5950bb2f,
                                 0xc4f2d0c7, 0xfc62bb2f, 0x8fa018fc, 0x3f5ec7b7,
                                 0x335271c2, 0xf29489f3, 0xeabda8fc, 0x82e46ebd,
                                 0xd19c12b4, 0xb04e16de, 0x9e83d0cb, 0x4e3c50a2};
  for (int i = 0; i < 10; i++) {
    cx_chacha_quarter_round(&state_array[0], &state_array[4], &state_array[8], &state_array[12]);
    cx_chacha_quarter_round(&state_array[1], &state_array[5], &state_array[9], &state_array[13]);
    cx_chacha_quarter_round(&state_array[2], &state_array[6], &state_array[10], &state_array[14]);
    cx_chacha_quarter_round(&state_array[3], &state_array[7], &state_array[11], &state_array[15]);

    cx_chacha_quarter_round(&state_array[0], &state_array[5], &state_array[10], &state_array[15]);
    cx_chacha_quarter_round(&state_array[1], &state_array[6], &state_array[11], &state_array[12]);
    cx_chacha_quarter_round(&state_array[2], &state_array[7], &state_array[8], &state_array[13]);
    cx_chacha_quarter_round(&state_array[3], &state_array[4], &state_array[9], &state_array[14]);
  }

...
static const unsigned char rfc6979_sha256_key1[] = {
    0xc4, 0x8b, 0x5c, 0x4c, 0x5b, 0x2a, 0xe3, 0x3d, 0xf9, 0x41, 0x92, 0xf6, 0x26, 0x9d, 0x55, 0x92,
    0x1f, 0xb0, 0xf0, 0x95, 0xbe, 0x4d, 0x84, 0x3b, 0x50, 0x7a, 0x2a, 0x71, 0x69, 0x54, 0xee, 0xa7};
static const unsigned char rfc6979_sha256_hash1[] = {
    0xef, 0x84, 0xda, 0xe8, 0xcb, 0x46, 0x95, 0x13, 0x14, 0x92, 0x05, 0x00, 0xec, 0x18, 0xa3, 0x86,
    0x70, 0xcd, 0xa4, 0x37, 0xb4, 0x5c, 0x7a, 0xea, 0xa7, 0x36, 0x62, 0x16, 0x66, 0x38, 0xf7, 0x4d};
/*
...
static const unsigned char rfc6979_sha256_key2[] = {
    0x00, 0x03, 0xf8, 0x31, 0x1e, 0xec, 0xe8, 0xca, 0xfe, 0xa3, 0xbf, 0x56, 0x8a, 0xa9, 0x04, 0x57,
    0xad, 0x6b, 0xbc, 0x47, 0xde, 0xed, 0x0e, 0x3c, 0x44, 0xe0, 0xaa, 0x94, 0xb9, 0x8a, 0xc4, 0x1f};
static const unsigned char rfc6979_sha256_hash2[] = {
    0xe5, 0x11, 0xc5, 0x43, 0x2e, 0xa4, 0xf8, 0x0a, 0xa4, 0x34, 0xb8, 0x42, 0xfe, 0x53, 0x98, 0xec,
    0x23, 0xd6, 0x2f, 0x3e, 0x0d, 0xa0, 0x6c, 0x24, 0x00, 0x00, 0x5e, 0xf9, 0xc7, 0xac, 0x1b, 0x4b};

void cx_st_rfc6979()
{
    cx_rng_rfc6979(CX_SHA256,
                   rfc6979_sha256_key1,
                   sizeof(rfc6979_sha256_key1),
                   rfc6979_sha256_hash1,
                   sizeof(rfc6979_sha256_hash1),
                   rfc6979_sha256_order1,
                   sizeof(rfc6979_sha256_order1),
                   OUT,
                   sizeof(rfc6979_sha256_order1));

    cx_rng_rfc6979(CX_SHA256,
                   rfc6979_sha256_key2,
                   sizeof(rfc6979_sha256_key2),
                   rfc6979_sha256_hash2,
                   sizeof(rfc6979_sha256_hash2),
                   rfc6979_sha256_order2,
                   sizeof(rfc6979_sha256_order2),
                   OUT,
                   sizeof(rfc6979_sha256_order1));
}

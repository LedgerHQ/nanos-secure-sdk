...
typedef struct {
    ...
    uint8_t  line_height;         ///< height of a line for all characters in pixels
    uint8_t  char_kerning;        ///< kerning for the font
    uint32_t first_unicode_char;  ///< unicode of the first character in \b bitmap and in \b
                                  ///< characters fields
    uint32_t last_unicode_char;   ///< unicode of the first character in \b bitmap and in \b
                                  ///< characters fields

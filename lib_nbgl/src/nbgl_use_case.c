...
static void displayAddressPage(uint8_t page, bool forceFullRefresh)
{
    ...
    nbgl_layoutTagValue_t tagValuePair
        = {.item = "Address", .value = (char *) addressConfirmationContext.address};
...
static void displaySkipWarning(void)
{
    nbgl_pageConfirmationDescription_t info = {.cancelText         = "Go back to review",
                                               .centeredInfo.text1 = "Skip message review?",
                                               .centeredInfo.text2
                                               = "You can skip directly to signing\nif you're sure "
...
// computes and returns the number of tag/values pairs displayable in a page, with the given list of
// tag/value pairs
    ...
    *tooLongToFit = false;
    while (nbPairsInPage < nbPairs) {
        ...
        currentHeight += nbgl_getTextHeightInWidth(BAGL_FONT_INTER_REGULAR_32px,
                                                   value,
                                                   SCREEN_WIDTH - 2 * BORDER_MARGIN,
                                                   tagValueList->wrapping);  // value height
 ...
 * @param quitCallback callback called when quit button is touched
 */
void nbgl_useCaseHomeExt(char                      *appName,
                         const nbgl_icon_details_t *appIcon,
                         char                      *tagline,
                         bool                       withSettings,
                         char                      *actionButtonText,
 ...
 * @param quitCallback callback called when quit button is touched
 */
void nbgl_useCasePlugInHome(char                      *plugInName,
                            char                      *appName,
                            const nbgl_icon_details_t *appIcon,
                            char                      *tagline,
                            char                      *subTagline,
 ...
 */
void nbgl_useCaseConfirm(char           *message,
                         char           *subMessage,
                         char           *confirmText,
                         char           *cancelText,
 ...
 * is false)
 */
void nbgl_useCaseStaticReviewLight(nbgl_layoutTagValueList_t *tagValueList,
                                   nbgl_pageInfoLongPress_t  *infoLongPress,
                                   char                      *rejectText,
                                   nbgl_choiceCallback_t      callback)
{
 ...
 * no copy)
 */
void nbgl_useCaseAddressConfirmationExt(char                      *address,
                                        nbgl_choiceCallback_t      callback,
                                        nbgl_layoutTagValueList_t *tagValueList)
{
    // save context

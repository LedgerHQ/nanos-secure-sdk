 ...
 * Incoming messages are store in the provided message buffer. It can be overlapped with io APDU
 * buffer to save RAM (but won't allow for multiple IO model (no mutual exclusion in the buffer
 * access))
 */

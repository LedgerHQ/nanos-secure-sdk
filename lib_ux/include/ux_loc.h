...
- bagl_font_unicode_character_t x nb_characters x 3 fonts
- bagl_font_unicode_t x 3 fonts
...
NB:
- there are 197 countries in the world, so 1 byte might be enought to store language information,

...
const bagl_element_t ux_layout_bnnn_elements[] = {
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  15, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
...
void ux_layout_bnnn_init(unsigned int stack_slot) {
  ...
  G_ux.stack[stack_slot].screen_before_element_display_callback = ux_layout_bnnn_prepro;

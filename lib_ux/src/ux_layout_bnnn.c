...
const bagl_element_t ux_layout_bnnn_elements[] = {
  ...
  {{BAGL_LABELINE                       , 0x10,   6,  15, 116,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, .text=NULL},
...
void ux_layout_bnnn_init(unsigned int stack_slot)
{
    ...
    G_ux.stack[stack_slot].element_arrays[0].element_array_count
        = ARRAYLEN(ux_layout_bnnn_elements);

...
const bagl_element_t ux_layout_nn_elements[] = {
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  29, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
  ...
  {{BAGL_LABELINE                       , 0x10,   0,  12, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
...
void ux_layout_nn_init(unsigned int stack_slot) {
  ...
  G_ux.stack[stack_slot].element_arrays[0].element_array = ux_layout_nn_elements;
  G_ux.stack[stack_slot].element_arrays[0].element_array_count = ARRAYLEN(ux_layout_nn_elements);

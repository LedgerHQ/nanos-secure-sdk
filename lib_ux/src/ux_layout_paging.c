...
static const bagl_element_t *ux_layout_paging_prepro_by_addr(const bagl_element_t *element)
{
    ...
    const ux_layout_paging_params_t *params
        = (const ux_layout_paging_params_t *) ux_stack_get_current_step_params();
...
{
    // don't display if null
    const ux_layout_paging_func_params_t *params
        = (const ux_layout_paging_func_params_t *) ux_stack_get_current_step_params();
                                       ...
                                       bagl_element_callback_t prepro)
{
    ...
    ux_layout_paging_compute(text, G_ux.layout_paging.current, &G_ux.layout_paging, LINE_FONT);
...
static unsigned int ux_layout_paging_button_callback_by_addr(unsigned int button_mask,
                                                             unsigned int button_mask_counter);
static unsigned int ux_layout_paging_button_callback_by_func(unsigned int button_mask,
                                                             unsigned int button_mask_counter);
...
void ux_layout_paging_redisplay_by_addr(unsigned int stack_slot)
{
    ...
    ux_layout_paging_redisplay_common(stack_slot,
                                      params->text,
                                      ux_layout_paging_button_callback_by_addr,
...
void ux_layout_paging_redisplay_by_func(unsigned int stack_slot)
{
    ...
    ux_layout_paging_redisplay_common(stack_slot,
                                      params->get_text(),
                                      ux_layout_paging_button_callback_by_func,
                                      ux_layout_paging_prepro_by_func);
}
...
static unsigned int ux_layout_paging_button_callback_common(unsigned int button_mask,
                                                            unsigned int button_mask_counter,
                                                             ...
                                                             unsigned int button_mask_counter)
{
    return ux_layout_paging_button_callback_common(
        button_mask, button_mask_counter, ux_layout_paging_redisplay_by_addr);
}
...
{
    return ux_layout_paging_button_callback_common(
        button_mask, button_mask_counter, ux_layout_paging_redisplay_by_func);
}

void ux_layout_paging_init_common(unsigned int                 stack_slot,
                                  const char                  *text,
                                  ux_layout_paging_redisplay_t redisplay)
{
    ...
    G_ux.layout_paging.count = ux_layout_paging_compute(
        text, -1UL, &G_ux.layout_paging, LINE_FONT);  // at least one page
...
{
    const ux_layout_paging_func_params_t *params
        = (const ux_layout_paging_func_params_t *) ux_stack_get_step_params(stack_slot);
    if (params->get_text == NULL) {
        return;
    }
    ux_layout_paging_init_common(
        stack_slot, params->get_text(), ux_layout_paging_redisplay_by_func);
}
...
// function callable externally which reset the paging (to be called before init when willing to

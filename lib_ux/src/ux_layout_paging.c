                                       ...
                                       bagl_element_callback_t prepro)
{
    ...
    ux_layout_paging_compute(text, G_ux.layout_paging.current, &G_ux.layout_paging, font_id);
...
STATIC_IF_NOT_INDEXED unsigned int ux_layout_paging_button_callback_common(
    unsigned int                 button_mask,
    unsigned int                 button_mask_counter,

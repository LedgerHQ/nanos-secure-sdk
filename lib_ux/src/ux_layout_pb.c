...
// 43 => 44
  ...
  {{BAGL_LABELINE                       , 0x11,   0,  44, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, .text=NULL},
...
// 26 => 28
  ...
  {{BAGL_LABELINE                       , 0x11,   0, 28, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, .text=NULL},
#else
...
const bagl_element_t* ux_layout_pb_prepro(const bagl_element_t* element) {
  ...
  switch (element->component.userid) {
    ...
    case 0x10:
      ...
      G_ux.tmp_element.text = (const char*)(((const ux_layout_pb_params_t*)params)->icon);
#endif //defined(HAVE_INDEXED_STRINGS)
      break;

    case 0x11:
#if defined(HAVE_INDEXED_STRINGS)
      G_ux.tmp_element.text = get_ux_loc_string(((const ux_loc_layout_icon_params_t*)params)->index);
#else //defined(HAVE_INDEXED_STRINGS)
      G_ux.tmp_element.text = ((const ux_layout_pb_params_t*)params)->line1;
#endif //defined(HAVE_INDEXED_STRINGS)
      break;
  }

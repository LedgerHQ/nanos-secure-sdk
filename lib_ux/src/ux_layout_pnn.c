...
const bagl_element_t ux_layout_pnn_elements[] = {
  ...
  {{BAGL_LABELINE                       , 0x11,   0,  37, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
  {{BAGL_LABELINE                       , 0x12,   0,  51, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
#else // TARGET_NANOX
  // erase
  ...
  {{BAGL_LABELINE                       , 0x11,  41,  12, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
  {{BAGL_LABELINE                       , 0x12,  41,  26, 128,  32, 0, 0, 0        , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_REGULAR_11px, 0  }, NULL, 0, 0, 0, NULL, NULL, NULL },
#endif // TARGET_NANOX
...
void ux_layout_pnn_init(unsigned int stack_slot) {
  ...
  G_ux.stack[stack_slot].element_arrays[0].element_array = ux_layout_pnn_elements;
  G_ux.stack[stack_slot].element_arrays[0].element_array_count = ARRAYLEN(ux_layout_pnn_elements);

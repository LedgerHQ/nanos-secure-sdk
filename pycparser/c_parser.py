...
class CParser(PLYParser):
    ...
    def p_parameter_declaration_1(self, p):
        """ parameter_declaration   : declaration_specifiers declarator
                                    | declaration_specifiers declarator PLENGTH LPAREN ID RPAREN
                                    | declaration_specifiers declarator PLENGTH LPAREN constant_expression RPAREN
        """
        spec = p[1]
        if not spec['type']:
    ...
    def p_parameter_declaration_2(self, p):
        """ parameter_declaration   : declaration_specifiers abstract_declarator_opt
                                    | declaration_specifiers abstract_declarator_opt PLENGTH LPAREN ID RPAREN
                                    | declaration_specifiers abstract_declarator_opt PLENGTH LPAREN constant_expression RPAREN
        """
        spec = p[1]
        if not spec['type']:
            spec['type'] = [c_ast.IdentifierType(['int'],
    ...
    def p_block_item_2(self, p):
        """ block_item  : __ASM type_qualifier LPAREN unified_string_literal RPAREN SEMI
                        | __ASM type_qualifier LPAREN unified_string_literal COLON unified_string_literal LPAREN primary_expression RPAREN RPAREN SEMI
                        | __ASM type_qualifier LPAREN unified_string_literal COLON COLON unified_string_literal LPAREN primary_expression RPAREN RPAREN SEMI
                        | __ASM type_qualifier LPAREN unified_string_literal COLON unified_string_literal LPAREN primary_expression RPAREN COLON unified_string_literal LPAREN primary_expression RPAREN RPAREN SEMI
        """
        p[0] = [c_ast.Constant(
                'string', p[3], self._coord(p.lineno(1)))]
